 ...
 */
 ...
 /*  PROTOTYPES  */
 void DelayMicros_2(uint32_t microsec);
 ...
 int8_t BNO055_Init_2(uint8_t address)
    ...
    if(address == BNO055_ADDRESS_A){
        I2C_ScanBus_BNO055_A();
    }

    if(address == BNO055_ADDRESS_B){
        I2C_ScanBus_BNO055_B();
    }
     TIMER_Init(); // Initialize timer module for delay functions.
     if (I2C_Init_2() != SUCCESS)
     {
     ...
     DelayMicros_2(30000);
     printf("BNO055 initialized at 0x%x\n", address);
     return byteReturn;
 ...
 int BNO055_ReadAccelX_2(uint8_t address) {
    return I2C_ReadInt_2(address, BNO055_ACCEL_DATA_X_LSB_ADDR, 0);
}
 ...
 int BNO055_ReadAccelY_2(uint8_t address) {
    return I2C_ReadInt_2(address, BNO055_ACCEL_DATA_Y_LSB_ADDR, 0);
}
 ...
 int BNO055_ReadAccelZ_2(uint8_t address) {
    return I2C_ReadInt_2(address, BNO055_ACCEL_DATA_Z_LSB_ADDR, 0);
}
 ...
 {
     return (I2C_ReadInt_2(address, BNO055_GYRO_DATA_X_LSB_ADDR, 0));
 }
 ...
 {
     return (I2C_ReadInt_2(address, BNO055_GYRO_DATA_Y_LSB_ADDR, 0));
 }
 ...
 {
     return (I2C_ReadInt_2(address, BNO055_GYRO_DATA_Z_LSB_ADDR, 0));
 }
 ...
 {
     return (I2C_ReadInt_2(address, BNO055_MAG_DATA_X_LSB_ADDR, 0));
 }
 ...
 {
     return (I2C_ReadInt_2(address, BNO055_MAG_DATA_Y_LSB_ADDR, 0));
 }
 ...
 {
     return (I2C_ReadInt_2(address, BNO055_MAG_DATA_Z_LSB_ADDR, 0));
 }
 ...
 {
     return (I2C_ReadRegister_2(address, BNO055_TEMP_ADDR));
 }
